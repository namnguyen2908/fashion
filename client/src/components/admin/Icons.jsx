...
export function IconChevron({ expanded = false, className = "w-4 h-4" }) {
  return (
    <svg className={`transition-transform duration-300 ${expanded ? "rotate-90" : ""} ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
